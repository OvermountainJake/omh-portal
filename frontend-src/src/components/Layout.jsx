...
const NAV_ITEMS = [
  ...
  { path: '/compliance', label: 'Teacher Compliance', icon: ShieldCheck, always: true, coming: true },
  { divider: 'Operations' },
  ...
  { path: '/time-off', label: 'Time Off Tracker', icon: Clock, always: true, coming: true },
  { divider: 'Admin', adminOnly: true },
  { path: '/financials', label: 'Financial Performance', icon: DollarSign, adminOnly: true, coming: true },
  { path: '/staffing', label: 'Staffing Schedule', icon: Users, adminOnly: true, coming: true },
  { path: '/directory', label: 'Employee Directory', icon: UserSquare2, adminOnly: true, coming: true },
